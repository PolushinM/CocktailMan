...
**[Issue #7](https://github.com/PolushinM/CocktailMan/issues/7)** ***Добавление русского языка***, чтобы русскоязычные описания коктейлей тоже понимал. Нужно перевести все рецепты датасета автоматическим переводчиком на русский язык, добавить их в обучающую выборку, обучить заново модель FastText.
